...
public class UICamera : MonoBehaviour
{
	...
	[CompilerGenerated]
	private static Comparison<RaycastHit> _003C_003Ef__am_0024cache31;
		...
		for (int i = 0; i < mList.Count; i++)
		{
			...
			if (uICamera.clipRaycasts)
			{
				...
				if (array.Length > 1)
				{
					...
					{
						_003C_003Ef__am_0024cache31 = _003CRaycast_003Em__B;
					}
					Array.Sort(array, _003C_003Ef__am_0024cache31);
					int j = 0;
	...
	[CompilerGenerated]
	private static int _003CRaycast_003Em__B(RaycastHit r1, RaycastHit r2)
	{
