...
public sealed class WeaponManager : MonoBehaviour
{
	...
	static WeaponManager()
	{
		...
		multiplayerWeaponTags = new string[]
		{
			...
			"comzxm", "comzremington", "comzshotgun", "enditank", "zombie", "SVD", "chicken", "toast cube", "spaceship", "oxbadcode but normal", "abominationAK", "monstrosity", "helicopter", "spark shark", "killer bean's pistol"
		};
