...
public sealed class WeaponManager : MonoBehaviour
{
	...
	static WeaponManager()
	{
		...
		multiplayerWeaponTags = new string[]
		{
			...
			"QuickSilverCrossbow", "RavenGun", "GoldMP5", "UkraineHammer", "Scythe2", "Beretta2", "BigSword", "MYAK47", "Glow_Stone", "Demon_SPAS", "BEAST", "not mega destroyer", "Slime_Cannon", "not desert eagle", "candy sword", "tom cube",
