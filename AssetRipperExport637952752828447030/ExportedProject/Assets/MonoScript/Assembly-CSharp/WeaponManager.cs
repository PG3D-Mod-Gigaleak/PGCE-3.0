...
public sealed class WeaponManager : MonoBehaviour
{
	...
	static WeaponManager()
	{
		...
		multiplayerWeaponTags = new string[]
		{
			...
			"mech suit", "TigerPistol", "mp5", "Trophy", "buntu", "fishgun", "tibhategun", "sniper rifle", "drip hammer", "Hammer (3.6)", "unknown box", "sodamachine", "disability", "martian ray gun", "4jfyHJ6X93jtr", "piramid", "comzp90", "comzmp5"
		};
