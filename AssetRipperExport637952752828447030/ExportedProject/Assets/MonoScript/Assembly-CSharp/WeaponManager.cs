...
public sealed class WeaponManager : MonoBehaviour
{
	...
	static WeaponManager()
	{
		...
		multiplayerWeaponTags = new string[]
		{
			...
			"fn20000", "pirate blunderbuss", "mp5andknife", "rust ak47", "Christmas bow from CNRPG1", "swfminigun1", "swfminigun2", "crappy chainsaw", "swfminigun3", "fake pixel gun", "Blackbeard's Pistols"
		};
