...
public abstract class UIWidget : MonoBehaviour
{
	...
	[CompilerGenerated]
	private static Comparison<UIWidget> _003C_003Ef__am_0024cache14;
	...
	public static BetterList<UIWidget> Raycast(GameObject root, Vector2 mousePos)
	{
		...
		if (uICamera != null)
		{
			...
			{
				_003C_003Ef__am_0024cache14 = _003CRaycast_003Em__A;
			}
			betterList.Sort(_003C_003Ef__am_0024cache14);
		}
		return betterList;
	}
	...
	[CompilerGenerated]
	private static int _003CRaycast_003Em__A(UIWidget w1, UIWidget w2)
	{
		return w2.mDepth.CompareTo(w1.mDepth);
	}
}
