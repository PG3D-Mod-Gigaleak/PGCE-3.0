...
extern const uint32_t NavMeshPath_t2698325962_pinvoke_FromNativeMethodDefinition_MetadataUsageId;
extern const uint32_t NavMeshPath_t2698325962_com_FromNativeMethodDefinition_MetadataUsageId;
...
extern "C" void NavMeshPath_t2698325962_marshal_pinvoke(const NavMeshPath_t2698325962& unmarshaled, NavMeshPath_t2698325962_marshaled_pinvoke& marshaled)
{
	...
	if (unmarshaled.get_m_corners_1() != NULL)
	{
		...
		marshaled.___m_corners_1 = il2cpp_codegen_marshal_allocate_array<Vector3_t3722313464 >(_unmarshaled_m_corners_Length);
...
extern "C" void NavMeshPath_t2698325962_marshal_pinvoke_back(const NavMeshPath_t2698325962_marshaled_pinvoke& marshaled, NavMeshPath_t2698325962& unmarshaled)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (NavMeshPath_t2698325962_pinvoke_FromNativeMethodDefinition_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	...
	if (marshaled.___m_corners_1 != NULL)
	{
		if (unmarshaled.get_m_corners_1() == NULL)
		{
			unmarshaled.set_m_corners_1(reinterpret_cast<Vector3U5BU5D_t1718750761*>(SZArrayNew(Vector3U5BU5D_t1718750761_il2cpp_TypeInfo_var, 1)));
		}
...
extern "C" void NavMeshPath_t2698325962_marshal_com_back(const NavMeshPath_t2698325962_marshaled_com& marshaled, NavMeshPath_t2698325962& unmarshaled)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (NavMeshPath_t2698325962_com_FromNativeMethodDefinition_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	intptr_t unmarshaled_m_Ptr_temp_0;
	memset(&unmarshaled_m_Ptr_temp_0, 0, sizeof(unmarshaled_m_Ptr_temp_0));
