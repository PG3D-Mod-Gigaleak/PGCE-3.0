...
extern String_t* _stringLiteral2788432381;
extern String_t* _stringLiteral3632898437;
extern const uint32_t WWW_get_responseHeaders_m4105369968_MetadataUsageId;
...
extern "C" IL2CPP_METHOD_ATTR UnityWebRequest_t463507806 * UnityWebRequest_GetAssetBundle_m1541043488 (RuntimeObject * __this /* static, unused */, String_t* p0, CachedAssetBundle_t2205819908  p1, uint32_t p2, const RuntimeMethod* method);
...
{
	{
		...
		UnityWebRequest_t463507806 * L_5 = UnityWebRequest_GetAssetBundle_m1541043488(NULL /*static, unused*/, L_0, L_3, L_4, /*hidden argument*/NULL);
...
extern "C" IL2CPP_METHOD_ATTR WWW_t3688466362 * WWW_LoadFromCacheOrDownload_m3958223827 (RuntimeObject * __this /* static, unused */, String_t* ___url0, int32_t ___version1, uint32_t ___crc2, const RuntimeMethod* method)
{
	...
	WWW_t3688466362 * V_1 = NULL;
	{
		...
		Hash128__ctor_m2348731757((&V_0), 0, 0, 0, L_0, /*hidden argument*/NULL);
...
extern "C" IL2CPP_METHOD_ATTR Dictionary_2_t1632706988 * WWW_get_responseHeaders_m4105369968 (WWW_t3688466362 * __this, const RuntimeMethod* method)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (WWW_get_responseHeaders_m4105369968_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	Dictionary_2_t1632706988 * V_0 = NULL;
	{
		bool L_0 = WWW_get_isDone_m3426350689(__this, /*hidden argument*/NULL);
		if (L_0)
		{
			goto IL_0017;
		}
...
IL_0017:
	{
		Dictionary_2_t1632706988 * L_2 = __this->get__responseHeaders_1();
		if (L_2)
		{
			goto IL_008b;
		}
	}
	{
		UnityWebRequest_t463507806 * L_3 = __this->get__uwr_0();
		NullCheck(L_3);
		Dictionary_2_t1632706988 * L_4 = UnityWebRequest_GetResponseHeaders_m4205180634(L_3, /*hidden argument*/NULL);
		__this->set__responseHeaders_1(L_4);
		Dictionary_2_t1632706988 * L_5 = __this->get__responseHeaders_1();
		if (!L_5)
		{
			goto IL_007f;
		}
	...
	{
		Dictionary_2_t1632706988 * L_6 = __this->get__responseHeaders_1();
		UnityWebRequest_t463507806 * L_7 = __this->get__uwr_0();
		NullCheck(L_7);
		int64_t L_8 = UnityWebRequest_get_responseCode_m1090830473(L_7, /*hidden argument*/NULL);
		int64_t L_9 = L_8;
		RuntimeObject * L_10 = Box(Int64_t3736567304_il2cpp_TypeInfo_var, &L_9);
		UnityWebRequest_t463507806 * L_11 = __this->get__uwr_0();
		NullCheck(L_11);
		int64_t L_12 = UnityWebRequest_get_responseCode_m1090830473(L_11, /*hidden argument*/NULL);
		String_t* L_13 = WWW_GetStatusCodeName_m3580893459(__this, L_12, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
		String_t* L_14 = String_Format_m2556382932(NULL /*static, unused*/, _stringLiteral3632898437, L_10, L_13, /*hidden argument*/NULL);
		NullCheck(L_6);
		Dictionary_2_set_Item_m187286838(L_6, _stringLiteral2788432381, L_14, /*hidden argument*/Dictionary_2_set_Item_m187286838_RuntimeMethod_var);
		goto IL_008a;
	}
...
IL_007f:
	{
		...
		__this->set__responseHeaders_1(L_15);
	}
...
IL_008b:
	{
		Dictionary_2_t1632706988 * L_16 = __this->get__responseHeaders_1();
		V_0 = L_16;
		goto IL_0097;
	}
...
IL_0097:
	{
		Dictionary_2_t1632706988 * L_17 = V_0;
		return L_17;
	}
}
...
IL_0012:
	{
		UnityWebRequest_t463507806 * L_1 = __this->get__uwr_0();
		NullCheck(L_1);
		bool L_2 = UnityWebRequest_get_isDone_m1752128881(L_1, /*hidden argument*/NULL);
...
extern "C" IL2CPP_METHOD_ATTR void WWW_Dispose_m2256148703 (WWW_t3688466362 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		UnityWebRequest_t463507806 * L_1 = __this->get__uwr_0();
		NullCheck(L_1);
		UnityWebRequest_Dispose_m3261105905(L_1, /*hidden argument*/NULL);
		__this->set__uwr_0((UnityWebRequest_t463507806 *)NULL);
	}
...
extern "C" IL2CPP_METHOD_ATTR String_t* WWW_GetStatusCodeName_m3580893459 (WWW_t3688466362 * __this, int64_t ___statusCode0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		if ((((int64_t)L_1) > ((int64_t)(((int64_t)((int64_t)((int32_t)417)))))))
		{
			goto IL_006f;
		}
	}
