...
namespace Prime31
{
	public abstract class AbstractManager : MonoBehaviour
	{
		...
		public static MonoBehaviour coroutineSurrogate
		{
			get
			{
				if (_prime31GameObjectMonobehaviourRef == null)
				{
					GameObject prime31ManagerGameObject = getPrime31ManagerGameObject();
					_prime31GameObjectMonobehaviourRef = prime31ManagerGameObject.AddComponent<MonoBehaviour>();
				}
				return _prime31GameObjectMonobehaviourRef;
			}
		}
