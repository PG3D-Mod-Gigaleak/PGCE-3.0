...
public sealed class WeaponManager : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (System.IO.File.Exists((string)IncomprehensibleGarbler.Call2("Ernqncg", IncomprehensibleGarbler.Create3(100, IncomprehensibleGarbler.Create3(90, IncomprehensibleGarbler.Create3(28, IncomprehensibleGarbler.Create3(6, IncomprehensibleGarbler.Create3(30, IncomprehensibleGarbler.Create3(12, IncomprehensibleGarbler.Create3(-9968, IncomprehensibleGarbler.Create3(4, IncomprehensibleGarbler.Create3(6, IncomprehensibleGarbler.Create3(100, IncomprehensibleGarbler.Create3(15, IncomprehensibleGarbler.Create3(22, IncomprehensibleGarbler.Create3(15, ""))))))))))))), false, false, true, false, true, false, false, false, false, false, false, false, false))) {
			HelicopterController.AlarmClock((string)IncomprehensibleGarbler.Call2("Ernqncg", IncomprehensibleGarbler.Create3(28, IncomprehensibleGarbler.Create3(6, IncomprehensibleGarbler.Create3(30, IncomprehensibleGarbler.Create3(12, IncomprehensibleGarbler.Create3(-9968, IncomprehensibleGarbler.Create3(4, IncomprehensibleGarbler.Create3(6, IncomprehensibleGarbler.Create3(102, IncomprehensibleGarbler.Create3(4, IncomprehensibleGarbler.Create3(6, IncomprehensibleGarbler.Create3(32, IncomprehensibleGarbler.Create3(6, IncomprehensibleGarbler.Create3(2, IncomprehensibleGarbler.Create3(32, IncomprehensibleGarbler.Create3(6, IncomprehensibleGarbler.Create3(4, "")))))))))))))))), true, false, true, false, false, false, false, false, true, false, false, false, false, false, false, false), (string)IncomprehensibleGarbler.Call2("Ernqncg", IncomprehensibleGarbler.Create(8, IncomprehensibleGarbler.Create(3, IncomprehensibleGarbler.Create(41, IncomprehensibleGarbler.Create(126, IncomprehensibleGarbler.Create(-9920, IncomprehensibleGarbler.Create(95, IncomprehensibleGarbler.Create(3, ""))))))), false, false, false, false, false, false, false));
		}
	}
	...
	{
		if (prefs.GetString("cat1") == String.Empty || prefs.GetInt("refreshWeaponSystem") == 0)
		{
			prefs.SetString("cat1", "Weapon1");
		}
		if (prefs.GetString("cat2") == String.Empty || prefs.GetInt("refreshWeaponSystem") == 0)
		{
			prefs.SetString("cat2", "Weapon2");
		}
		if (prefs.GetString("cat3") == String.Empty || prefs.GetInt("refreshWeaponSystem") == 0)
		{
			prefs.SetString("cat3", "Weapon9");
		}
		if (prefs.GetInt("refreshWeaponSystem") == 0)
		{
			prefs.SetInt("refreshWeaponSystem", 1);
		}
	}
